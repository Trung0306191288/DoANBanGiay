...
@section('body')
    <div class="box_btn_search">
        <div class="flex_btn_search">
            <div class="btn_add"><a href="{{ route('xulyThemDanhMucCapHai') }}">Thêm mới</a></div>
            ...
            <a href="{{ route('LayDsDanhMucCapHai') }}" class="btn_redirect"><ion-icon name="reload-circle-outline"></ion-icon></a>
        </div>
    </div>
