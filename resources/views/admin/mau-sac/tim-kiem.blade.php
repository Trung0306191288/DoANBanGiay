...
<div class="box_btn_search">
    <div class="flex_btn_search">
        ...
        <a href="{{ route('LayDsMauSac') }}" class="btn_redirect"><ion-icon name="reload-circle-outline"></ion-icon></a>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="flex_options">
                            ...
                            <a class="delete_main" data-id="{{ $v['id'] }}" data-type="mau-sac"><span><ion-icon name="trash-outline"></ion-icon></span></a>
                        </div>
                    </td>
                </tr>
            @endforeach
