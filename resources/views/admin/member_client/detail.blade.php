                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="box_input">
                                ...
                                <input type="text" class="form-control" name="name_member" id="name_member" placeholder="Tên thành viên" value="{{ ($update != NULL) ? $update['ho_ten']: ''}}">
                                @error('name_member')
                                    <span>{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="item_box_list">
                                ...
                                <select class="form-select" name="cate_member" aria-label="Default select example">
                                    ...
                                    @foreach($cate_mem as $k => $v)
                                        <option {{ ($v['id'] == $cate_mem_up['id']) ? 'selected':''; }} value="<?= $v['id'] ?>"><?= $v['ten_vai_tro'] ?></option>
                                    @endforeach
                                </select>
                                @error('cate_member')
